...
import { mockFetch, DEMO_MODELS, DEMO_CONFIG } from './demo-mock';
...
export const getModels = async (
	...
	// Tryb demonstracyjny - zwróć przykładowe modele
	console.log('Demo mode: returning sample models');
	return DEMO_MODELS;
};
...
export const getBackendConfig = async () => {
	// Tryb demonstracyjny - zwróć przykładową konfigurację
	console.log('Demo mode: returning sample config');
	return DEMO_CONFIG;
};
